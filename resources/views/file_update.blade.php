                                ...
                                <form method="post" action="/file/update" enctype="multipart/form-data">
                                    ...
                                    <div class="uk-grid" data-uk-grid-margin="">
                                        <div class="uk-width-medium-1-1">
                                            ...
                                            You can select file from here.
                                        </div>
                                        <div class="uk-width-medium-1-1">
                                            <select  data-md-selectize name="directory" onchange="sendid(this.value)">
                                        ...
                                        <div class="uk-button uk-form-select" data-uk-form-select style="margin-left: 7%;">
                                        <span></span>
                                            <select   name="ff" class="file" >
                                        ...
                                        {{-- <div class="uk-width-medium-1-1">
                                            <select  data-md-selectize name="files">
                                                <option value="">Select File to be updated</option>
                                                @foreach($table as $i)
                                                    <option value="{{$i->id}}">{{$i->name}}</option>
                                                @endforeach
                                            </select>
...
@section('scripts')
    ...
    <script type="text/javascript">
        function sendid(id){
            ...
            //window.location="/file/update/"+id;
        }
    </script>
@endsection