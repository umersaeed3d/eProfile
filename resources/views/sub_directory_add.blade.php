        ...
        <div class="md-card-content">
            ...
            <div class="uk-grid" data-uk-grid-margin="">
                <div class="uk-width-medium-6-10 uk-push-2-10 uk-row-first">
                    ...
                    <form action="/subdirectory/new" method="post">
                        {{csrf_field()}}
                        <div class="uk-grid">
                            <div class="uk-width-large-1-1 uk-width-medium-1-2">
                                <div class="uk-input-group">
                                    <div class="md-input-wrapper">
                                        <input type="text" class="md-input" id="name"  name="name" placeholder="Subdirectory Name"><span class="md-input-bar "></span>
                                    </div>
                                    <div>

                                    <select name="main_directory_id" required>
                                        <option value="null">Select Main_Directory..</option>
                                        @foreach ($main_dir as $element)
