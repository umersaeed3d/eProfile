                            ...
                            <table id="dt_individual_search" class="uk-table uk-table-bordered uk-table-hover">
                                ...
                                @foreach($table as $i)
                                    <tr>
                                        ...
                                        <td>{{$i->name}}</td>
                                        <td>{{$i->email}}</td>
                                        <td>{{$i->workstation_name}}</td>
                                        <td><img src="{{asset('uploads/files/users').'/'.$i->image}}"></td>
                                        <td>
                                           <a href="/user/edit/{{$i->id}}" style="" class=" md-btn-icon"><i class="material-icons no_margin">edit</i></a>
                                            <a href="#" onclick="destroy('{{$i->id}}','{{$i->name}}')" style="" class=" md-btn-icon"><i class="material-icons no_margin">close</i></a>
                                        </td>
                                    </tr>
                                    <?php $j++; ?>
                                @endforeach
