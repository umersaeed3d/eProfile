        ...
        <div class="md-card-content">
            ...
            <div class="uk-grid" data-uk-grid-margin="">
                <div class="uk-width-medium-6-10 uk-push-2-10 uk-row-first">
                    ...
                    <h3 class="heading_a">Company</h3>
                    <br>
                    <form action="/workstation/new" method="post" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="uk-grid">
                            <div class="uk-width-large-1-1 uk-width-medium-1-2">
                                <div class="uk-input-group">
                                    <div class="md-input-wrapper">
                                        <input type="text" class="md-input" id="name"  name="name" placeholder="Company Name"><span class="md-input-bar "></span>
                                    </div>

                                     <label class="uk-form-label">Company Logo:</label>
                                    <div class="md-input-wrapper">

                                        <input type="file" class="md-input" id="name"  name="image" ><span class="md-input-bar "></span>
                                    </div>
